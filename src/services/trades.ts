...
// Pre-populated with sample historical trades for demo
const trades: TradeCall[] = [
  {
    ...
    takeProfit2: 50000,
    confidence: 72,
    reasoning: 'F&G at 18 (extreme fear), RSI oversold, OBV divergence bullish',
    indicators: ['Fear & Greed < 20', 'RSI < 30', 'OBV Divergence'],
    status: 'tp2_hit',
    exitPrice: 49800,
    exitTimestamp: '2026-01-28T14:20:00Z',
    pnlPercent: 17.2,
    outcome: 'win'
  },
  {
    ...
    takeProfit2: 2800,
    confidence: 68,
    reasoning: 'Weekly bottom confirmed, volume surge +180%, MACD bullish cross',
    indicators: ['Volume Surge', 'MACD Cross', 'Weekly Support'],
    status: 'tp1_hit',
    exitPrice: 2520,
    exitTimestamp: '2026-01-25T09:45:00Z',
    pnlPercent: 10.5,
    outcome: 'win'
  },
  {
    ...
    takeProfit2: 110,
    confidence: 65,
    reasoning: 'Extreme fear bounce play, high volume capitulation',
    indicators: ['Fear & Greed < 25', 'Volume Spike', 'Support Test'],
    status: 'stopped',
    exitPrice: 74.50,
    exitTimestamp: '2026-01-24T03:15:00Z',
    pnlPercent: -12.4,
    outcome: 'loss'
  },
  {
    ...
    takeProfit1: 61886,
    confidence: 60,
    reasoning: 'Orderbook imbalance -93%, heavy asks, L/S ratio overcrowded',
    indicators: ['Orderbook Imbalance', 'L/S Ratio High', 'Resistance Test'],
    status: 'stopped',
    exitPrice: 66013,
    exitTimestamp: '2026-02-01T08:30:00Z',
    pnlPercent: -1.34,
    outcome: 'loss'
  },
  {
    ...
    takeProfit2: 30.00,
    confidence: 70,
    reasoning: 'F&G at 12, RSI 22, volume +210%, weekly bottom formation',
    indicators: ['Extreme Fear', 'RSI Oversold', 'Volume Surge'],
    status: 'tp1_hit',
    exitPrice: 26.20,
    exitTimestamp: '2026-02-05T11:00:00Z',
    pnlPercent: 16.4,
    outcome: 'win'
  },
  {
